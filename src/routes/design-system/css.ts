export const button = `inline-flex items-center gap-x-2 w-max rounded-md px-2.5 py-1 shadow-sm border transition-colors ease-in
    bg-white text-slate-600 border-slate-300
    focus-visible:ring-2 focus-visible:ring-offset-2
    hover:bg-slate-50 hover:text-slate-700 hover:border-slate-300
    focus-visible:bg-white focus-visible:text-slate-700 focus-visible:border-slate-300
    focus-visible:ring-offset-white focus-visible:ring-slate-400/60
    active:bg-slate-100 focus-visible:active:bg-slate-100 active:text-slate-700 active:border-slate-300
    ...
    dark:focus-visible:bg-slate-600 dark:focus-visible:border-slate-500 dark:focus-visible:text-white
