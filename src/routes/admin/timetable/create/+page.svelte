...
<main class="w-full max-w-7xl px-8 flex flex-col gap-12">
    <Button variant="link" href="/admin/timetable">
    ...
    <Card.Root class="mx-auto max-w-sm w-full">
        <Card.Header>
            <Card.Title class="text-2xl">Time Table</Card.Title>
            <Card.Description>Time Table Description</Card.Description>
        </Card.Header>
        <Card.Content>
            <CreateTimetableForm data={data.timetableForm} />
        </Card.Content>
    </Card.Root>
</main>
