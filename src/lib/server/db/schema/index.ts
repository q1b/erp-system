...
export * from "./program/course/module"
export * from "./program/course/resource"

export * from "./program/student/index"
export * from "./program/student/batch"

export * from "./program/time-table/index"
export * from "./program/time-table/period"
export * from "./program/time-table/attendance"

export * from "./program/lecture"
